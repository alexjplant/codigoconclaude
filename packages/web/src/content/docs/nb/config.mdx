...
For eksempel, hvis din globale konfigurasjon setter `theme: "opencode"` og `share: "manual"`, og prosjektkonfigurasjonen setter `model: "anthropic/claude-sonnet-4-5"`, vil den endelige konfigurasjonen inkludere alle tre innstillingene.
