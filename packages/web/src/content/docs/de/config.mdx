...
Wenn Ihre globale Konfiguration beispielsweise `theme: "opencode"` und `share: "manual"` und Ihre Projektkonfiguration `model: "anthropic/claude-sonnet-4-5"` festlegt, umfasst die endgültige Konfiguration alle drei Einstellungen.
