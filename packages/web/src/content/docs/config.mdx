...
For example, if your global config sets `share: "manual"` and your project config sets `model: "anthropic/claude-sonnet-4-5"`, the final configuration will include both settings.
