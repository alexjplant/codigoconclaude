...
Na przykład, jeśli konfiguracja globalna ustawi `theme: "opencode"` i `share: "manual"`, a konfiguracja projektu ustawi `model: "anthropic/claude-sonnet-4-5"`, ostateczna konfiguracja będzie zawierać wszystkie trzy ustawienia.
