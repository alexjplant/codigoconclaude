...
على سبيل المثال، إذا كان الإعداد العام يضبط `theme: "opencode"` و`share: "manual"`، وكان إعداد المشروع يضبط `model: "anthropic/claude-sonnet-4-5"`، فستتضمن الإعدادات النهائية الخيارات الثلاثة جميعها.
