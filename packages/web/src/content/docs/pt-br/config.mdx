...
Por exemplo, se sua configuração global define `share: "manual"` e sua configuração de projeto define `model: "anthropic/claude-sonnet-4-5"`, a configuração final incluirá as duas configurações.
