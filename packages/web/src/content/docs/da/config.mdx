...
For eksempel, hvis dine globale konfigurationssæt `share: "manual"`, og dine projektkonfigurationssæt `model: "anthropic/claude-sonnet-4-5"`, vil den endelige konfiguration integrere begge indstillinger.
