...
Par exemple, si votre configuration globale définit `share: "manual"` et que la configuration de votre projet définit `model: "anthropic/claude-sonnet-4-5"`, la configuration finale inclura les deux paramètres.
